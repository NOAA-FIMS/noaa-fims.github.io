...
[tests/testthat/test-setup_default_AgeSpecific.R]{.underline} - This code specifically tests that the setup_default_AgeSpecific() function from R/create_default_parameters.R is working  

[tests/testthat/test-setup_default_Selectivity.R]{.underline} - This code specifically tests that the setup_default_Selectivity() function from R/create_default_parameters.R is working  
