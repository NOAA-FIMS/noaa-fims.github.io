...
<div class="site-hero mb-5">
  <div class="site-intro">
    ...
    <p class="site-intro fs-5">
      ...
      <i class="fa-solid fa-user-gear"></i> <strong>Developer</strong><br>
      ...
      <i class="fa-solid fa-user-ninja"></i> <strong>Power User</strong><br>
      A repeat user of FIMS who wants to dig down into the source code to see how it is connected to R or someone who wants more control of their model than what the wrapper functions in R can provide. <br>
      <i class="fa-solid fa-person-arrow-down-to-line"></i> <strong>Receiver of Results</strong><br>
      Typically a manager or stakeholder who has a desire to explore the model output without wanting to know how to use FIMS themselves. <br>
    </p>
