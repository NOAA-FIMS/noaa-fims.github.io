...
<div class="sib-form" style="text-align: center; background-color: #c6e6f0; padding: 15px 0;">
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="padding: 15px 20px !important; max-width:350px; margin: 0 auto; text-align:center; background-color:rgba(255,255,255,1); border-width:1px; border-style:solid; border-color:#C0CCD9; border-radius:3px; direction:ltr">
