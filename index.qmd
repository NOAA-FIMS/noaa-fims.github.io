  ...
  - id: fims-resources-listing
    ...
    contents:
        - path: https://noaa-fims.github.io/FIMS/
          title: <i class="fab fa-r-project" aria-hidden="true"></i> FIMS Pkgdown
          description: >
            Pkgdown site for FIMS package.
        - path: https://noaa-fims.github.io/FIMS/doxygen/index.html
          title: <i class="fa-solid fa-plus" aria-hidden="true"></i> FIMS Doxygen
          description: >
            Doxygen documentation for FIMS C++ functions.
        - path: resources/packages.qmd
          title: <i class="fab fa-r-project" aria-hidden="true"></i> FIMS Packages
          description: >
            Packages associated with FIMS.
