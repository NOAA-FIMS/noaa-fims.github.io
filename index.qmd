...
<div class="sib-form" style="text-align: center; background-color: #fff; padding: 15px 0;">
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div></div>
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="padding: 10px !important; max-width:400px; margin: 0 auto; text-align:center; background-color:#f7fafb; border-width:1px; border-style:solid; border-color:#C0CCD9; border-radius:3px; direction:ltr">
      <form id="sib-form" method="POST" action="https://11796369.sibforms.com/serve/MUIFAK1XHMwXI2NT4stSrUOqzvk_N5p9vPeHoF3BCI1dgjJSFy-EiOCNK2tgyvJhpXso6jQu_TUclmZ1Aa5uESA9g4gzTrFel9mghDTJkgPDD-DVijIa3ax16iCbdvK3w8erhPbeNYuoUY-boD64ojPldsu0VNBEO-20emT2pQmH87NHI2-9D0wyZhyXf5mMWYmOUD89fvcHbFeQRQ==" data-type="subscription">
        <div style="padding: 5px 0;">
          <div class="sib-form-block" style="font-family:var(--bs-font-family-heading, inherit); font-size:calc(1.29rem + 0.48vw); font-weight:700; text-align:left; color:#0e6876; background-color:transparent; text-align:left">
            <p>FIMS Blog</p>
          </div>
        </div>
        <div style="padding: 5px 0;">
          <div class="sib-form-block" style="font-family:var(--bs-body-font-family); font-size:16px; text-align:left; color:#3C4858; background-color:transparent; text-align:left">
            <div class="sib-text-form-block">
              <p>Subscribe to our Blog and stay updated.</p>
            </div>
          </div>
        </div>
        <div style="padding: 5px 0;">
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                <label class="entry__label" style="font-weight: 700; text-align: left; font-family:var(--bs-body-font-family); font-size:16px; font-weight:700; text-align:left; color:#3c4858;" for="FIRSTNAME" data-required="*">Enter your first name</label>
                <div class="entry__field">
                  <input class="input " maxlength="200" type="text" id="FIRSTNAME" name="FIRSTNAME" autocomplete="off" data-required="true" required />
                </div>
              </div>
              <label class="entry__error entry__error--primary" style="font-family:var(--bs-body-font-family); font-size:16px; text-align:left; color:#661d1d; background-color:#ffeded; border-color:#ff4949; border-radius:3px;">
              </label>
            </div>
          </div>
        </div>
        <div style="padding: 5px 0;">
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                <label class="entry__label" style="font-weight: 700; text-align: left; font-family:var(--bs-body-font-family); font-size:16px; font-weight:700; text-align:left; color:#3c4858;" for="LASTNAME" data-required="*">Enter your last name</label>
                <div class="entry__field">
        ...
        <div style="padding: 5px 0;">
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                <label class="entry__label" style="font-weight: 700; text-align: left; font-family:var(--bs-body-font-family); font-size:16px; font-weight:700; text-align:left; color:#3c4858;" for="EMAIL" data-required="*">Enter your email address to subscribe</label>
                <div class="entry__field">
              ...
              <label class="entry__specification" style="font-family:var(--bs-body-font-family); font-size:12px; text-align:left; color:#8390A4; text-align: left ">
