...
<div class="sib-form" style="text-align: center; background-color: #c6e6f0; padding: 15px 0;">
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div></div>
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="padding: 15px !important; max-width:450px; margin: 0 auto; text-align:center; background-color:rgba(255,255,255,1); border-width:1px; border-style:solid; border-color:#C0CCD9; border-radius:3px; direction:ltr">
      <form id="sib-form" method="POST" action="https://11796369.sibforms.com/serve/MUIFAK1XHMwXI2NT4stSrUOqzvk_N5p9vPeHoF3BCI1dgjJSFy-EiOCNK2tgyvJhpXso6jQu_TUclmZ1Aa5uESA9g4gzTrFel9mghDTJkgPDD-DVijIa3ax16iCbdvK3w8erhPbeNYuoUY-boD64ojPldsu0VNBEO-20emT2pQmH87NHI2-9D0wyZhyXf5mMWYmOUD89fvcHbFeQRQ==" data-type="subscription">
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="font-family:Helvetica, sans-serif; font-size:32px; font-weight:700; text-align:left; text-decoration:underline; color:#113d77; background-color:transparent; text-align:left">
            <p>FIMS Blog</p>
          </div>
        </div>
        <div style="padding: 8px 0;">
          ...
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                <label class="entry__label" style="font-weight: 700; text-align: left; font-family:Helvetica, sans-serif; font-size:16px; font-weight:700; text-align:left; color:#3c4858;" for="FIRSTNAME" data-required="*">Enter your first name</label>
        ...
        <div style="padding: 8px 0;">
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              <div class="form__label-row ">
                <label class="entry__label" style="font-weight: 700; text-align: left; font-family:Helvetica, sans-serif; font-size:16px; font-weight:700; text-align:left; color:#3c4858;" for="LASTNAME" data-required="*">Enter your last name</label>
                <div class="entry__field">
        ...
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="text-align: left">
            <button class="sib-form-block__button sib-form-block__button-with-loader" style="font-family:Helvetica, sans-serif; font-size:16px; font-weight:700; text-align:left; color:#FFFFFF; background-color:#0085ca; border-width:0px; border-radius:3px;" form="sib-form" type="submit">
