...
title: Resources
description: >
  Resources for learning skills that support developing FIMS.

  Use the category and sort controls on this page to narrow the list of resources.
listing:
  contents:
    ...
    - path: https://cran.rstudio.com/web/packages/Rcpp/vignettes/Rcpp-modules.pdf
      ...
      categories: [Rcpp]
    - path: https://www.rcpp.org/pdf/Rcpp-quickref.pdf
