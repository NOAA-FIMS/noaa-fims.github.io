...
listing:
  contents:
    ...
    - path: https://noaa-fims.github.io/FIMS/
      title: <i class="fab fa-r-project" aria-hidden="true"></i> FIMS R Documentation
      description: >
        Packagedown site for FIMS package.
      categories: [R]
    - path: https://noaa-fims.github.io/FIMS/doxygen/index.html
      title: <i class="fa-solid fa-plus" aria-hidden="true"></i> FIMS C++ Documentation
      description: >
